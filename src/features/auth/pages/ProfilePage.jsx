...
export default function ProfilePage() {
  ...
  // delete address and set default address
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12">
      <div className="text-center mb-10">
        ...
        <Heading level={2} data-testid="profile-page-title">
          My Profile
        </Heading>
      </div>
                  ...
                  <img
                    ...
                    className={`w-28 h-28 md:w-32 md:h-32 rounded-full object-cover ring-4
                      ${
                        isDark
                          ? "ring-primary-400/40"
                          : "ring-saffron-300/70 shadow-sacred"
                      }`}
                  />
                  <label
                    className={`absolute bottom-0 right-0 rounded-full p-2 cursor-pointer transition-all
                    ${
                      isDark
        ...
        <CardContent>
          <div className="space-y-3">
            ...
            {(!addresses || addresses.length === 0) && (
              <Text className="text-center py-6" color="muted">
        ...
        <CardContent>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
            {mockWishlist.map((item) => (
              ...
              >
                <div
                  className={`w-full aspect-square mb-3 rounded-xl flex items-center justify-center overflow-hidden
                  ${
                    isDark
                ...
                >
                  <Heart
                    size={38}
                    className={
                      isDark ? "text-primary-300/60" : "text-saffron-400/70"
                    }
                  />
                </div>
                ...
                <Text
                  color="ink"
                  className="font-semibold text-center mb-1 text-sm"
                >
                  {item.name}
                </Text>
                <Text

  ...
  return (
    <BackgroundWrapper>
      <div className="min-h-screen flex items-center justify-center p-4">
        {/* OUTER GLASS CARD */}
        <Card variant="glass" className="w-full max-w-md p-8 rounded-2xl shadow-lg">
          {/* Golden Badge */}
          ...
          <h1 className="text-4xl  font-extrabold text-center mb-2  bg-gradient-to-r 
            from-blue-600 
            to-indigo-600 
            dark:from-amber-300 
            dark:via-amber-400 
          ...
          <p className="mt-6 text-center text-sm text-gray-600 dark:text-gray-300">
            Didn’t receive OTP?{" "}
            <span className="text-amber-600 dark:text-amber-300 cursor-pointer font-medium hover:underline">Resend</span>
          </p>
        </Card>
      </div>
    </BackgroundWrapper>

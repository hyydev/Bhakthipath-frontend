    ...
    <BackgroundWrapper>
      ...
      <Section spacing="lg" className="min-h-screen flex items-center">
        ...
        >
          ...
          {/* Description */}
          <Text size="xl" className="max-w-3xl mx-auto mb-8 leading-relaxed animate-slide-up">
            Experience divine wisdom, connect with devotees, and deepen your spiritual practice
            with our comprehensive platform trusted by thousands of seekers.
          </Text>
      ...
      <Section spacing="lg">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <Text size="lg" className="mb-8">
            Join thousands of devotees who have transformed their lives through dedicated practice and divine guidance.
          </Text>
          <Button variant="gradient" size="lg">
